...
public class AttackOnTitanChap1 extends AppCompatActivity {
    ...
    public void get_image(){
        ...
        GetImageAPI api_get = new Retrofit.Builder().baseUrl("https://api.jsonbin.io/").addConverterFactory(GsonConverterFactory.create(gson)).build().create(GetImageAPI.class);
